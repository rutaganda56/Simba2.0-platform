      ...
      >
        <Card className="shadow-2xl border-0 dark:bg-slate-800">
          <CardHeader className="space-y-1 text-center">
            <CardTitle className="text-3xl font-bold text-teal-700 dark:text-teal-500">Welcome Back</CardTitle>
            <CardDescription>
              Login to access your Simba account and track orders
            </CardDescription>
          </CardHeader>
          ...
          <div className="p-6 pt-0 text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <Link href="/register" className="text-teal-700 dark:text-teal-500 hover:underline font-semibold">
                Register
              </Link>
            </p>
          </div>
